      ...
      try {
        ...
        form.setFieldsValue({
          ...
          Weight: response.data.data.weight
            ? response.data.data.weight.match(/\d+\.?\d*/g)
            : null,
          Volume: response.data.data.volume
            ? response.data.data.volume.match(/\d+\.?\d*/g)
            : null,
          Shelf_life: response.data.data.shelf_life
            ? response.data.data.shelf_life?.match(/\d+\.?\d*/g)
            : null,
  ...
  const handleCreate = async (value) => {
    ...
    try {
      ...
      if (value.Madein !== null) {
        formData.append("MadeIn", value.Madein.trim());
      }
