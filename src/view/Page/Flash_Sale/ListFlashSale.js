...
export default function ListFlashSale() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        setwaiting(true);
        const response = await axios.get(APILink() + "FlashSale/SAdmin", {
          headers: {
  ...
  const ChangeStatus = async (index) => {
    try {
      ...
      const response = await axios.get(
        APILink() + "FlashSale/ChangeStatus/" + index,
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
          ...
          <tbody>
            {records?.map((item, index) => (
              ...
              >
                ...
                <td>{moment(item.end_Date).format("DD/MM/YYYY HH:mm:ss")}</td>
                {/* <td>
                  ...
                  >
                    ...
                    <Button>
                      <Link
                        ...
                        to={`/updateflashsale?flashsaleId=${item.id}`}
                      >
                        Update
                      </Link>
                    </Button>
